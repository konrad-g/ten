    ...
    function AppClient() {
        ...
        this.setupPjax = function () {
            document.addEventListener("DOMContentLoaded", function () {
                new pjax_1["default"]({ selectors: ["title", "header", "main"], cacheBust: false });
                nprogress_js_1["default"].configure({ parent: "body", showSpinner: false });
                _this.pagesCtrl.setupPage();
            });
...
var PagesCtrl = /** @class */ (function () {
    function PagesCtrl() {
        ...
        this.setupPage = function () {
            _this.closePage();
            var page = _this.executeCurrentPageLogic();
            if (page)
...
var Toast = /** @class */ (function () {
    function Toast(parent) {
        ...
        this.showSuccess = function (title, message) {
            var text = _this.getCustomToast(title, message, "success");
            _this.addToast(text);
        };
        this.showInfo = function (title, message) {
            var text = _this.getCustomToast(title, message, "info");
            _this.addToast(text);
        };
        this.showWarning = function (title, message) {
            var text = _this.getCustomToast(title, message, "warning");
            _this.addToast(text);
        };
        this.showError = function (title, message) {
            var text = _this.getCustomToast(title, message, "error");
            _this.addToast(text);
        };
        this.getCustomToast = function (title, message, type) {
        ...
        this.addToast = function (toastHtml) {
        ...
        this.getContainer = function () {
            ...
            _this.parent.append(newContainer);
            return newContainer;
        };
