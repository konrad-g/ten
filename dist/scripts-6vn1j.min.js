...
var AppClient = /** @class */ (function () {
    function AppClient() {
        ...
        this.showMultipleToasts = function () {
            _this.toastLogger.showInfo("This is info", "This is info message");
            _this.toastLogger.showSuccess("Success", "You made it. Congratulations!");
            _this.toastLogger.showWarning("This is warning", "This is warning message");
            _this.toastLogger.showError("This is error", "This is error message");
        };
    }
    return AppClient;
}());
